...
const REAL_INPUT_TYPES = [
  ...
  // السعودية
  'فاتورة مشتريات',
  'فاتورة مشتريات خدمات',
  'ادخال مواد الى المستودع',
  'ادخال مواد الى انستجرام',
  'فاتورة إدخال الى الأندلس مول',
  'فاتورة إدخال الى الجوري مول',
  'فاتورة إدخال الى الرياض',
  'فاتورة إدخال الى النور مول',
  'فاتورة إدخال الى الياسمين مول',
  'فاتورة إدخال الى تبوك',
  'فاتورة إدخال الى ذا فيلج',
  'فاتورة إدخال الى مكه مول',
  'فاتورة إدخال الى يو ووك',
];
...
const SALE_TYPES = [
  ...
  // السعودية
  'فاتورة مبيعات الأندلس مول',
  'فاتورة مبيعات الجوري مول',
  'فاتورة مبيعات الرياض',
  'فاتورة مبيعات النور مول',
  'فاتورة مبيعات الياسمين مول',
  'فاتورة مبيعات انستغرام',
  'فاتورة مبيعات تبوك',
  'فاتورة مبيعات ذا فيلج',
  'فاتورة مبيعات مكه مول',
  'فاتورة مبيعات يو ووك',
...
const SALE_RETURN_TYPES = [
  ...
  // عمان
  'مرتجع مبيعات انستغرام',
  'فاتورة مرتجع مبيعات سعر نصف الجملة',
  // السعودية
  'فاتورة مرتجع مبيعات الأندلس مول',
  'فاتورة مرتجع مبيعات الباسمين مول',
  'فاتورة مرتجع مبيعات الجوري مول',
  'فاتورة مرتجع مبيعات الرياض',
  'فاتورة مرتجع مبيعات النور مول',
  'فاتورة مرتجع مبيعات تبوك',
  'فاتورة مرتجع مبيعات ذا فيلج',
  'فاتورة مرتجع مبيعات مكه مول',
  'فاتورة مرتجع مبيعات يو ووك',
];
...
const TRANSFER_TYPES = ['فاتورة الإخراج',
  ...
  // السعودية
  'اخراج مواد من المستودع',
  'فاتورة إخراج من الأندلس مول',
  'فاتورة إخراج من الجوري مول',
  'فاتورة إخراج من الرياض',
  'فاتورة إخراج من النور مول',
  'فاتورة إخراج من الياسمين مول',
  'فاتورة إخراج من تبوك',
  'فاتورة إخراج من ذا فيلج',
  'فاتورة إخراج من مكه مول',
  'فاتورة إخراج من يو ووك',
];
